...
cronwork("stackoverflow.update", function(){
  if(!conf_file_exists("last_updatet")){
     ...
     conf_file_create("last_updatet.cow_config", new Date().getTime());
     return;
  }

  //wee get last update
  var update = conf_file_get("last_updatet.cow_config");
  config_file_create("last_updatet.cow_config", new Date().getTime());
